...
<head>
    ...
    <script src="{{ asset('https://kit.fontawesome.com/759d509dbf.js') }}" crossorigin="anonymous"></script>
    <meta
        name="description"
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
            ...
            <a href="{{ route('admin.post.index') }}" class="brand-link">
                <!--begin::Brand Image-->
                <div class="bg-light rounded-circle text-center" style="width: 30px">
                    <i class="fa-solid fa-p text-dark "></i>
                </div>

                <!--end::Brand Image-->
                <!--begin::Brand Text-->
                <span class="brand-text fw-light">E-Posts</span>
                <!--end::Brand Text-->
            </a>
            <!--end::Brand Link-->
        </div>
...
<!--begin::Third Party Plugin(OverlayScrollbars)-->
<script
    src="{{ asset('https://cdn.jsdelivr.net/npm/overlayscrollbars@2.10.1/browser/overlayscrollbars.browser.es6.min.js') }}"
...
<script
    src="{{ asset('https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js') }}"
